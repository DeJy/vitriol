# Vitriol Tutorial (JSX + Ionic)

Welcome to your new Vitriol project! This template combines Mithril.js (with JSX), Ionic Framework for building mobile-ready applications.
...
**Example:** `src/components/MyCard.jsx`
