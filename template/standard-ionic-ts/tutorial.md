# Vitriol Tutorial (Standard + Ionic + TypeScript)

Welcome to your new Vitriol project! This template combines Mithril.js, Ionic Framework, and TypeScript for building robust mobile-ready applications.
...
**Example:** `src/components/MyCard.ts`
